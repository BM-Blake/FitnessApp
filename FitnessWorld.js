  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.section}>
        ...
        <Text style={styles.workoutDesp}>Welcome to join fitness journey, where every rep brings you closer to your best self. Let’s crush your fitness goals together!</Text>
